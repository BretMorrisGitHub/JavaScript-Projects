...
//This function is for placing am x or o in a square.
function placeXOrO(squareNumber){
    //This condition ensures a square hasn't been selected already.
    //The .some() method is used to check each element of the selectSquare array
    //to see if it contains the square number clicked on.
    if(!selectedSquares.some(element => element.includes(squareNumber))){
        //This variable retrieves the HTML element by id that was clicked.
...
function checkWinConditions(){
    ...
    function arrayIncludes(squareA, squareB, squareC){
        ...
        //true if returned amd our else if condition executes the drawLine() function.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2){
    ...
    let x1 = coordX1,
        ...
        //This line indicates where the end of a lines x axis is.
        y2 = coordY2,
        //This variable stores temporary x axis data we update on our animation loop.
        x = x1,
